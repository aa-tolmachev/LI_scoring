...
def main(json_params = None):
        ...
        url = 'http://lendinvest.ru/service/score/{0}?inq_loan_amount={1}&inq_loan_period={2}&payment_frequency={3}&payment_amount={4}&force=true'.format(client_id,loan_amount,loan_period,payment_frequency,payment_amount)
        url = 'https://ktotam:etolendinvest@lendinvest.ru/service/score/{0}?inq_loan_amount={1}&inq_loan_period={2}&payment_frequency={3}&payment_amount={4}&force=true'.format(client_id,loan_amount,loan_period,payment_frequency,payment_amount)
